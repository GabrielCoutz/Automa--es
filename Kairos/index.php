            ...
            <div class="hero-content">
              ...
              <p class="wow fadeInUp mouseoff" data-wow-delay=".6s">
                Mais que uma ferramenta, um meio para alcançar seu sucesso no mercado. (ih ala o corno tbm é coach KKKK)
							...
							<a href="Cadastro/cadastro.php" class="main-btn btn-hover wow fadeInUp" data-wow-delay=".6s">Começar Agora</a>
            </div>
					</div>
					<div class="col-lg-6">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="about-content mb-50">
							...
							<a href="Cadastro/cadastro.php" class="main-btn btn-hover">Incrível né? =D</a>
						</div>
					</div>
				</div>
			</div>
		...
		<section id="service" class="service-section img-bg pt-100 pb-100 mt-150 mouseoff">
			<div class="container">
				...
				<div class="view-all-btn text-center pt-30">
					<a href="Cadastro/cadastro.php" class="main-btn btn-hover">Porque não começar hoje?</a>
				</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-xl-6 col-lg-5">
						<div class="cta-btn text-lg-end mb-50">
							<a href="Cadastro/cadastro.php" class="main-btn btn-hover text-uppercase">Basta nos contatar!</a>
						</div>
					</div>
				</div>
			</div>
